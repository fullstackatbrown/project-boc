...
export default function About() {
  return (
    <div className="h-full min-h-screen w-full">
      ...
      <div id="content" className="text-center mt-8"></div>

      <div id="content" className="text-center p-5">
        <div
          id="title-text"
          className="mt-[5vh] mb-4 text-4.5xl-responsive font-bold text-primary font-circ-std"
        >
          <div
            id="paragraph"
            className="mx-60 mb-8 text-xl font-[100] text-left leading-10"
          >
            <p>
              {" "}
              The BOC runs everything from{" "}
              <span className="font-bold">local walks</span> to{" "}
              <span className="font-bold">backpacking weekends, </span>
              to <span className="font-bold">local bike rides, </span> to{" "}
              <span className="font-bold">kayaking</span> to{" "}
              <span className="font-bold">day hikes </span>
              to <span className="font-bold">climbing</span> to{" "}
          ...
          >
            <p>
              ...
              3,000 members of the Brown community—faculty, graduate students,
              and undergraduate students included. If you’d like to support our
        ...
        <div
          id="content"
          className="text-center mt-8 mb-8 flex justify-center gap-4"
        >
          <WhiteButton
